function [bootstat, bootsam] = bootstrap(nboot,bootfun,varargin)
...
%                used by BOOTSTRP.  If a parallel pool is already open, this 
...
%                prior to invoking BOOTSTRP with 'UseParallel' set to TRUE.
%
...
%            PARPOOL, PARFOR, GCP, HIST, KSDENSITY.
